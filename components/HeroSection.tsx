    ...
    >
      ...
      <div ref={heroAreaRef} className="relative flex-1 flex items-center justify-center" style={{ minHeight: '80svh' }}>
        ...
        >
          ...
          {/* App Store CTA + Audio control — equal width */}
          <div className="flex flex-col items-stretch gap-3 mt-8 pointer-events-auto">
            <a
              href="https://apps.apple.com/app/photo-bounce/idXXXXXXXXX"
              className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-full text-white text-sm font-medium transition-all duration-200 hover:brightness-110 active:scale-95"
              style={{
            ...
            <button
              onClick={toggleMusic}
              className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-full font-medium text-sm transition-all duration-200 active:scale-95 hover:brightness-110"
              style={{
