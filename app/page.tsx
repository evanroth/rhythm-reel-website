      ...
      >
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-white/65 text-sm leading-relaxed mb-4">
            ...
            {' '}as well the permanent collection of MoMA, among other places.
          </p>
          <p className="text-white/65 text-sm leading-relaxed mb-4">
            I&apos;m also a lifelong music lover who has been spending more and more of my after-hours
            time learning to DJ, making beats (I made the songs included in the app and playing on
            this site), and building music software. RhythmReel is the latest result of that obsession.
          </p>
